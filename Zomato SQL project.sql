...
7.  Which item was purchased justb before the customer became a member?
...
9.  If buying each product generates points for eg 5rs=2 zomato point and eaach product has different purchasing points 
...
10.  In the the first one year after a customerb joins the gold program (including their joining date) irrespective
